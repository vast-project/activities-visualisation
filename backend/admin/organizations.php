			...
			<table width="100%" border="1" class="sortable">
				<thead>
					<tr>
						...
						<th aria-sort="ascending"><button class="sortbtn">Name<span aria-hidden="true"></span></button></th>
						<th><button type="button"class="sortbtn">Phone<span aria-hidden="true"></span></button></th>
						<th><button type="button"class="sortbtn">Address<span aria-hidden="true"></span></button></th>
					</tr>
				</thead>
				<tbody>
					<?php
