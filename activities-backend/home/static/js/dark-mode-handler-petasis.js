...
const dashboardsClass = ["light", "dark"];
...
function setPage(theme) {
    ...
    page.classList.remove(dashboardsClass[0])
    page.classList.remove(dashboardsClass[1])
    page.classList.add(dashboardsClass[theme])
}
